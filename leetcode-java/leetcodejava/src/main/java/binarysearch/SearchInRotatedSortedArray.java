...
public class SearchInRotatedSortedArray {
  ...
  @Test
  public void case4() { Assert.assertEquals(4, search(new int []{4,5,6,7,0,1,2}, 0));}

  @Test
  public void case5() { Assert.assertEquals(0, search(new int []{3,5, 1}, 3));}

  @Test
  public void case6 () { Assert.assertEquals(4, search(new int []{4,5,6,7,8,1,2,3}, 8));}
}
